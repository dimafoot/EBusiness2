<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm.aspx.cs" Inherits="WebServiceEmployee.WebForm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" language="javascript">
            function GetEmployeeById() {
                ...
                WebServiceEmployee.EmployeeWebService.GentEmployeeDb(id, GetEmployeeByIdCallBack);
            }
        ...
        <table>
            <tr>
                ...
                <td style="font-weight: 700">
                    ...
                    <input id="ButtonNbr" type="button" value="Set Number" onclick="ButtonNbr_click"/></td>
            </tr>
